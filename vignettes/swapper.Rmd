...
as the grouping factor. We induce DE in 10% of the original genes.

```{r simulateDE}
set.seed(123) # for reproducibility
sim <- simulateDE(sce, groups = sce$Treatment, prop_DE = 0.1)
rowData(sim)
...
contains information regarding which gene was swapped with which and in which of
